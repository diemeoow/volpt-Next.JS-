            ...
            >
              ...
              `}
                ...
                <button
                    ...
                    className="flex items-center justify-center w-12 h-12 rounded-full text-red-400/85 hover:text-red-50 hover:bg-red-300/85 transition-all active:scale-95"
                    title="Выйти"
                >
