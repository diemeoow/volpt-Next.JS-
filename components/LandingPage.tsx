...
export default function LandingPage() {
    return (
        <div className="min-h-center flex flex-col items-center justify-center p-6 relative">
            <div className="max-w-4xl w-full flex flex-col gap-8">
                {/* Шапка */}
                <div className="text-center space-y-4 animate-float">
                    <div className="inline-block p-4 rounded-full bg-white/5 backdrop-blur-lg border border-white/20 shadow-2xl mb-4">
                        <svg
                            width="130"
                            height="130"
                            viewBox="0 0 87 31"
                    ...
                    <p className="text-xl text-white/70 max-w-lg mx-auto font-light">
                        Цифровая платформа для работы с учебными группами,
                        дисциплинами и расписанием.
                    </p>
                </div>

                {/* Карточки */}
                <div className="grid grid-cols-3 md:grid-cols-1 gap-4 items-stretch">
                    ...
                    <GlassCard className="p-6 h-full">
                        <div className="flex items-start gap-4">
                            <Users className="w-8 h-8 text-pink-300 flex-shrink-0" />
                    ...
                    <GlassCard className="p-6 h-full">
                        <div className="flex items-start gap-4">
                            <BookOpen className="w-8 h-8 text-purple-300 flex-shrink-0" />
