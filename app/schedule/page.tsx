    ...
    <div className="p-4 md:p-6 max-w-7xl mx-auto w-full">
      ...
      <div className="mb-8 flex flex-col md:flex-row justify-between items-center gap-4">
        <div className="pl-2">
          ...
          <p className="text-white/50">Ваше расписание на неделю</p>
        </div>
        ...
        <GlassCard className="!rounded-full" intensity="low">
          <div className=" flex items-center gap-4 p-2 px-4">
            ...
            <span className="text-white font-semibold text-center tracking-wide whitespace-nowrap">
              {weekRange}
            </span>
            <button
              onClick={() => setWeekOffset((prev) => prev + 1)}
          ...
          >
            ...
            <div className="p-4 space-y-3 flex-1">
              {dayTemplate.lessons.length > 0 ? (
                  ...
                  .map((lesson) => {
                    ...
                    return (
                      <div
                        key={lesson.id}
                        onClick={() =>
                          handleLessonSelect(lesson.subject, lesson.group)
                        }
                        className="
                        ...
                        "
                      >
                        <div className="absolute top-2 right-2 text-[10px] text-white/40 font-mono font-bold">
                          #{lesson.pairNumber}
                        </div>

                        <div className="flex justify-between items-start mb-2 pr-4">
                          <span className="font-bold text-white/90 group-hover:text-blue-200 transition-colors text-sm line-clamp-1 shadow-black/10 drop-shadow-sm">
                            {lesson.subject}
                          </span>
                        </div>

                        <div className="flex items-center justify-between mt-2">
                          <span className="text-[10px] font-bold bg-blue-400/20 text-blue-100 px-2 py-0.5 rounded border border-blue-400/20 backdrop-blur-sm">
                            {lesson.group}
                          </span>
                          <div className="flex items-center gap-3 text-[10px] text-blue-100/60 font-medium">
                ...
                <div className="h-full flex items-center justify-center text-white/20 italic text-sm min-h-[100px]">
                  Нет предметов
                </div>
              )}
            </div>
