  ...
  return (
    <div className="p-4 md:p-6 pb-24 max-w-3xl mx-auto w-full">
      <div className="mb-8 pl-2 flex justify-between items-end">
        <div>
          <h2 className="text-3xl font-bold text-white">Мои группы</h2>
          <p className="text-white/50">Список групп и предметов</p>
        </div>
            ...
            >
              ...
              >
                <div className="flex items-center gap-4">
                  <div
                    className={`p-3 rounded-2xl transition-all duration-300 ${isExpanded ? "bg-blue-500 shadow-[0_0_20px_rgba(59,130,246,0.5)]" : "bg-white/10"}`}
                  >
                ...
                <ChevronDown
                  className={`w-6 h-6 text-white/70 transition-transform duration-300 ${isExpanded ? "rotate-180" : ""}`}
                />
              </button>
